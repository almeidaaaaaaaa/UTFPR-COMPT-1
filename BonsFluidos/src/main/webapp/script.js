document.addEventListener('DOMContentLoaded', function() {
  ...
  function setupAuthPage() {
    ...
    // Validar formulário de cadastro de voluntário
    ...
    // Validar formulário de cadastro de beneficiado
    const benForm = document.getElementById('form-beneficiado');
    if (benForm) {
      benForm.addEventListener('submit', function(e) {
        e.preventDefault();
        const nome = document.getElementById('ben-nome').value;
        const rg = document.getElementById('ben-rg').value;
        const email = document.getElementById('ben-email').value;
        const password = document.getElementById('ben-password').value;
        const endereco = document.getElementById('ben-endereco').value;
        
        if (nome && rg && email && password && endereco) {
          alert('Cadastro de beneficiado realizado com sucesso!');
          benForm.reset();
        } else {
          alert('Por favor, preencha todos os campos.');
        }
